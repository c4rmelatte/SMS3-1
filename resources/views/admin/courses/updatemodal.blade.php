<!-- Modal toggle -->
<button id="updateProductButton" data-modal-target="{{$course->id}}-updateProductModal"
    data-modal-toggle="{{$course->id}}-updateProductModal">
...
<!-- Main modal -->
<div id="{{$course->id}}-updateProductModal" tabindex="-1" aria-hidden="true"
            ...
            <form action="{{ route('course.update', $course->id) }}" method="POST">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="description" value="{{$course->description}}" id="description"
