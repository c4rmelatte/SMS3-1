...
<button id="updateProductButton" data-modal-target="{{$building->id}}-updateProductModal"
    data-modal-toggle="{{$building->id}}-updateProductModal">
...
<!-- Main modal -->
<div id="{{$building->id}}-updateProductModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Building
                            Name</label>
                        <input type="text" value="{{$building->name}}" name="name" id="name"
                    ...
                    <div class="">
                        ...
                        <input type="text" name="description" value="{{$building->description}}" id="description"
