...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[#375735] dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">      
         ...
         <li>
            <a href="{{url('/student/subjects')}}" class="menu-item flex items-center p-2 text-white rounded-r-lg dark:text-white hover:bg-[#1F342E] dark:hover:bg-gray-700 group {{ request()->is('student/subjects') ? 'active' : '' }}">
         ...
         <li>
            <a href="{{url('/student/announcements')}}" class="menu-item flex items-center p-2 text-white rounded-r-lg dark:text-white hover:bg-[#1F342E] dark:hover:bg-gray-700 group {{ request()->is('student/announcements') ? 'active' : '' }}">
         ...
         <li>
            <a href="{{url('/student/attendance')}}" class="menu-item flex items-center p-2 text-white rounded-r-lg dark:text-white hover:bg-[#1F342E] dark:hover:bg-gray-700 group {{ request()->is('student/attendance') ? 'active' : '' }}">
            <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
         ...
         <li>
            <a href="{{url('/student/enrollmentform')}}" class="menu-item flex items-center p-2 text-white rounded-r-lg dark:text-white hover:bg-[#1F342E] dark:hover:bg-gray-700 group {{ request()->is('student/enrollmentform') ? 'active' : '' }}">
            <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
