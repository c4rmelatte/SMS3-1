...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[#38574F] dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">      
         ...
         <li>
            <a href="{{url('/student/subjects')}}" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#1F342E] dark:hover:bg-gray-700 group {{ request()->is('student/subjects') ? 'bg-[#1F342E]' : '' }}">
