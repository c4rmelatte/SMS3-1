...
<div class="flex justify-center m-5">
    ...
    <svg class="w-5 h-5 text-text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
